...
TARGET_NETWORK_UPDATE_FREQUENCY = 4000#40000
MODEL_PERSISTENCE_UPDATE_FREQUENCY = 5000#10000
REPLAY_START_SIZE = 50000#50000

EXPLORATION_MAX = 0.1#1.0
EXPLORATION_MIN = 0.1
...
class DDQNTrainer(DDQNGameModel):
    ...
    def __init__(self, game_name, input_shape, action_space):
        ...
        self.target_model.add(Dense(action_space))
